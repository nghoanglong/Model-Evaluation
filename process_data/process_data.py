...
def assign_sentiment(file_phrases, file_sentimentLabels):
    ...
    very_negative_phrases = df_assignLabels.loc[(df_assignLabels['sentiment values'] >= 0.0) & (df_assignLabels['sentiment values'] <= 0.2)]
...
if __name__ == '__main__':
    # demo split dataset
    # split_dataset('./collect_data/stanfordSentimentTreebank/datasetSentences.txt',
    #             './collect_data/stanfordSentimentTreebank/datasetSplit.txt')

    # demo assign sentiment
    assign_sentiment('./stanfordSentimentTreebank/dictionary.txt',
